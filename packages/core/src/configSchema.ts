      ...
      properties: {
        notebound: {
          ...
          properties: {
            ...
            tuplet: {
              $ref: '#/definitions/annotated_bezier',
          ...
          properties: {
            ...
            notebound: {
              ...
              properties: {
                ...
                barnumber: { $ref: '#/definitions/notebound_pos', align: { $ref: '#/definitions/align' } },
                c_jumplines: {
                  type: 'object',
                  additionalProperties: false,
                  patternProperties: {
                ...
                nconf: {
                  ...
                  additionalProperties: false,
                  patternProperties: {
                    'v_d*': { $ref: '#/definitions/nconf_entry' },
                  },
                },
            ...
            chords: {
              ref: '#/definitions/nb_annotations',
              style: { type: 'string' },
            },
            stringnames: {
              type: 'object',
