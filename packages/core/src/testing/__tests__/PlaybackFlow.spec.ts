...
`)
  ...
  it('expands nested repeats with implicit fallback start', () => {
    const flow = expandFlow(`X:1
T:Nested
M:4/4
L:1/4
K:C
AAAA |: BBBB |: cccc | dddd :| eeee :| ffff |: gggg | aaaa :| bbbb :|
`)
    ...
    expect(flow.map((step) => step.sourceTime)).toEqual([
      ...
      6144, 6528, 6912, 7296,
      7680, 8064, 8448, 8832,
      9216, 9600, 9984, 10368,
      10752, 11136, 11520, 11904,
      9216, 9600, 9984, 10368,
      10752, 11136, 11520, 11904,
      12288, 12672, 13056, 13440,
      9216, 9600, 9984, 10368,
      10752, 11136, 11520, 11904,
      12288, 12672, 13056, 13440,
    ])
