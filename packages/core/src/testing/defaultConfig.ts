...
export const defaultTestConfig: ZupfnoterConfig = {
  layout: {
    ...
    DURATION_TO_STYLE: {
      ...
      d96: { sizeFactor: 0.9,  fill: 'empty',  dotted: false },
      d64: { sizeFactor: 0.9,  fill: 'empty',  dotted: false },
      d48: { sizeFactor: 0.7,  fill: 'empty',  dotted: true  },
      d32: { sizeFactor: 0.7,  fill: 'empty',  dotted: false },
